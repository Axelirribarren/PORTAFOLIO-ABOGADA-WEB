...
const Contact = () => {
  return (
    <section id="contacto" className="rounded-2xl bg-gradient-to-b from-gray-100 to-gray-200 py-10 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="bg-white shadow-lg rounded-2xl p-8 border border-gray-300">
          ...
          <div className="flex justify-center gap-6 mt-8">
            <a href="https://wa.me/XXXXXXXXXXX" target="_blank" className="text-green-600 hover:text-green-800 transition">
              <Phone className="w-8 h-8" />
            </a>
            <a href="https://www.instagram.com/tuusuario" target="_blank" className="text-pink-600 hover:text-pink-800 transition">
              <Instagram className="w-8 h-8" />
            </a>
            <a href="https://www.facebook.com/tuusuario" target="_blank" className="text-blue-600 hover:text-blue-800 transition">
