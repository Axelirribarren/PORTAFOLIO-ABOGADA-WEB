const Hero = () => {
  return (
    <section
      className="text-center py-20 bg-[#f4f4f2] flex flex-col items-center"
      id="inicio"
    >
      <img
        src="/logo-negro.PNG"
      ...
      <div className="bg-white shadow-lg rounded-2xl p-10 md:p-10 flex flex-col items-center max-w-lg mx-auto border border-gray-300">
        ...
        <p className="text-gray-700 text-lg text-center leading-relaxed mt-6">
          ...
          <strong>derecho de familia y divorcios</strong>, mi compromiso es
          ofrecer soluciones legales efectivas con un enfoque humano y
          compasivo. Cada caso es único, por lo que brindo una{" "}
          <strong>atención personalizada</strong>, asegurando que mis clientes
